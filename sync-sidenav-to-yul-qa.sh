echo
echo "Dry run of syncing local version of Side Nav Omeka theme with the Yale Omeka.net-based QA server"
...
echo
echo "These are the files that will be copied to or deleted from the Omeka.net server"
